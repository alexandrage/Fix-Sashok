...
public class BaseUtils {
		...
		try {
			...
			try {
				font = Font.createFont(Font.TRUETYPE_FONT,
						BaseUtils.class.getResourceAsStream("/net/launcher/theme/" + name + ".ttf"));
			} catch (Exception e) {
				try {
					font = Font.createFont(Font.TRUETYPE_FONT,
							BaseUtils.class.getResourceAsStream("/net/launcher/theme/" + name + ".otf"));
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
	...
	public static BufferedImage genServerIcon(String[] args) {
		...
		if (args[1] != null && args[2] != null) {
			if (args[1].equals(args[2]))
				return Files.light.getSubimage(Files.light.getHeight(), 0, Files.light.getHeight(),
						Files.light.getHeight());
			return Files.light.getSubimage(Files.light.getHeight() * 2, 0, Files.light.getHeight(),
					Files.light.getHeight());
		}
		return Files.light.getSubimage(Files.light.getHeight() * 3, 0, Files.light.getHeight(),
				Files.light.getHeight());
	}
	...
	public static void updateLauncher() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(
				Starter.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
