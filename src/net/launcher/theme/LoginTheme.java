...
public class LoginTheme {
	...
	public static ButtonStyle toAuth = new ButtonStyle(262, 307, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle toLogout = new ButtonStyle(96, 367, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);

	public static ButtonStyle toGame = new ButtonStyle(262, 307, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle toPersonal = new ButtonStyle(262, 367, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle toOptions = new ButtonStyle(96, 307, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle toRegister = new ButtonStyle(96, 367, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	...
	public static ButtonStyle update_exe = new ButtonStyle(96, 440, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle update_jar = new ButtonStyle(262, 440, 150, 47, "font", "button", 16F,
			Color.decode("0xd4dc7b"), true, Align.CENTER);
	public static ButtonStyle update_no = new ButtonStyle(600, 0, 0, 0, "font", "button", 0F, Color.decode("0xd4dc7b"),
			true, Align.CENTER);

	public static ComboboxStyle servers = new ComboboxStyle(128, 431, 250, 25, "font", "combobox", 14F,
			Color.decode("0xA67A53"), true, Align.CENTER);
	public static ServerbarStyle serverbar = new ServerbarStyle(155, 470, 260, 16, "font", 15F,
			Color.decode("0xA67A53"), true);
